...
class App:
    ...
    def init_sound(self):
        pyxel.sounds[0].set(notes="c3e3g3c4c4", tones="s", volumes="4", effects="nnnnf", speed=7)
        pyxel.sounds[1].set(
        ...
        harmony1 = (
            "a1 a1 a1 b1  f1 f1 c2 c2  c2 c2 c2 c2  g1 g1 b1 b1" * 3 + "f1 f1 f1 f1 f1 f1 f1 f1 g1 g1 g1 g1 g1 g1 g1 g1"
        )
    ...
    def check_death(self):
        hx, hy = self.snake[0]
        if hx < 0 or hy < SCORE_H or hx >= SCREEN_W or hy >= SCREEN_H or len(self.snake) != len(set(self.snake)):
            self.die()
